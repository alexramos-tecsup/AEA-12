...
namespace CodeFirstDemo.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,Name,Price,SellerID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,Name,Price,SellerID")] Product product)
        {
            if (ModelState.IsValid)
            {
